    ...
    <div class="card">
      ...
      <div class="card-body">
        <form style='min-height:250px' id="form_">
          ...
          <div class="row mb-3">
            <div class="col-md-3">
              <label class="form-label">ID Kelurahan *</label>
              <div class="form-input">
                <input type="text" class="form-control" name="kelurahan_id" value="<?= isset($row) ? $row->kelurahan_id : '' ?>" required <?= $disabled ?> maxlength=10>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="kelurahan" value="<?= isset($row) ? $row->kelurahan : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
          <div class="row mb-3">
...
<?php
$send['data'] = ['selectProvinsi', 'selectKabupaten', 'selectKecamatan'];
...
<script>
  $('#submitButton').click(function() {
    ...
    <?php if (isset($row)) { ?>
      values.append('kelurahan_id_old', '<?= $row->kelurahan_id ?>');
    <?php } ?>
