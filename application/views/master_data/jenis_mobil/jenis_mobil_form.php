          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="jenis_mobil" value="<?= isset($row) ? $row->jenis_mobil : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <select class='form-control' id="id_merk_mobil" name="id_merk_mobil" required>
                  <?php if (isset($row)) { ?>
                    <option value="<?= $row->id_merk_mobil ?>"> <?= $row->merk_mobil ?></option>
                  <?php } ?>
                </select>
              </div>
            </div>
...
<script>
  $('#submitButton').click(function() {
    ...
    <?php if (isset($row)) { ?>
      values.append('id_jenis_mobil', <?= $row->id_jenis_mobil ?>);
    <?php } ?>
