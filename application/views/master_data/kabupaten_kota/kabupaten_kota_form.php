        ...
        <form style='min-height:250px' id="form_">
          ...
          <div class="row mb-3">
            <div class="col-md-3">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="kabupaten_id" value="<?= isset($row) ? $row->kabupaten_id : '' ?>" required <?= $disabled ?> maxlength=4>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="kabupaten" value="<?= isset($row) ? $row->kabupaten : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
          <div class="row mb-3">
...
<script>
  $('#submitButton').click(function() {
    ...
    <?php if (isset($row)) { ?>
      values.append('kabupaten_id_old', '<?= $row->kabupaten_id ?>');
    <?php } ?>
