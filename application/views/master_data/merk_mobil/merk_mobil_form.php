          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="merk_mobil" value="<?= isset($row) ? $row->merk_mobil : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <div class="input-group mb-3">
                  <input type="file" class="form-control" name="logo" <?= $disabled ?>>
                  <?php if (isset($row)) {
                    if ((string)$row->logo_big != '') { ?>
                      <label class="input-group-text btn-info text-white" onclick="showModalPreviewImages('<?= base_url($row->logo_big) ?>')"><i class='fa fa-eye'></i></label>
                  <?php }
                  } ?>
                </div>
              </div>
