        ...
        <form style='min-height:250px' id="form_">
          ...
          <div class="row mb-3">
            <div class="col-md-3">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="kecamatan_id" value="<?= isset($row) ? $row->kecamatan_id : '' ?>" required <?= $disabled ?> maxlength=7>
              </div>
            </div>
          </div>
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="kecamatan" value="<?= isset($row) ? $row->kecamatan : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
          <div class="row mb-3">
...
<?php
$send['data'] = ['selectProvinsi', 'selectKabupaten'];
...
<script>
  $('#submitButton').click(function() {
    ...
    <?php if (isset($row)) { ?>
      values.append('kecamatan_id_old', '<?= $row->kecamatan_id ?>');
    <?php } ?>
