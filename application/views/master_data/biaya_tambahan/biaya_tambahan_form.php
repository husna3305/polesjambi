          ...
          <div class="row mb-3">
            <div class="col-md-6">
              ...
              <div class="form-input">
                <input type="text" class="form-control" name="deskripsi_tambahan" value="<?= isset($row) ? $row->deskripsi_tambahan : '' ?>" required <?= $disabled ?>>
              </div>
            </div>
          </div>
...
<script>
  $('#submitButton').click(function() {
    ...
    <?php if (isset($row)) { ?>
      values.append('id_tambahan', <?= $row->id_tambahan ?>);
    <?php } ?>
