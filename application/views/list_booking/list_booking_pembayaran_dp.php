...
<div class="row">
  <div class="col-auto text-center flex-column d-none d-sm-flex">
    ...
    <h5 class="m-2">
      <span class="badge rounded-pill <?= ($row->status == 'menunggu_pembayaran' || $row->status == 'dp_lunas' || $row->status == 'tidak_datang') == true ? 'bg-primary' : 'bg-light border' ?>">&nbsp;</span>
    </h5>
    <?php if (($row->status == 'menunggu_pembayaran' || $row->status == 'dp_lunas' || $row->status == 'tidak_datang') == false) { ?>
      <div class="row h-50">
        <div class="col border-end">&nbsp;</div>
        <div class="col">&nbsp;</div>
      </div>
