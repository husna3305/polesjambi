...
<head>
  ...
  <!-- =======================================================
  * Template Name: Poles Jambi - v4.3.0
  * Template URL: https://bootstrapmade.com/Poles Jambi-free-onepage-bootstrap-theme/
...
<body>
  ...
  <header id="header" class="fixed-top header-transparent bg-dark">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html"><img src="<?= base_url('assets/front/') ?>/assets/img/mr.rubio-min.png"></a></h1>
      <!-- Uncomment below if you prefer to use an image logo -->
      <!-- <a href="index.html" class="logo"><img src="<?= base_url('assets/front/') ?>/assets/img/logo.png" alt="" class="img-fluid"></a>-->
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-1.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-2.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-3.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-4.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-5.png" class="img-fluid" alt="">
          </div>

          <div class="col-lg-2 col-md-4 col-6 d-flex align-items-center justify-content-center">
            <img src="<?= base_url('assets/front/') ?>/assets/img/clients/client-6.png" class="img-fluid" alt="">
          </div>
    ...
    <section id="about" class="about">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="<?= base_url('assets/front/') ?>/assets/img/slogan.jpg" class="img-fluid" alt="">
          </div>
    ...
    <section id="counts" class="counts section-bg">
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-3 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="1543" data-purecounter-duration="1" class="purecounter"></span>
            <p>Jam Kerja</p>
          </div>
    ...
    <!-- Proses Detailing Kami -->
    <section id="process" class="process">
      <div class="container">
        <div class="row justify-content-center">
          <h3>PROSES DETAILING KAMI</h3>
          <?php
          foreach ($proses as $key => $prs) { ?>
            <div class="col-md-4 img-process">
              <img src="<?= base_url($prs->path_img_big) ?>" alt="car" class="img-fluid">
            </div>
          <?php } ?>
        </div>
      </div>
    ...
    <section id="hasil" class="hasil">
      <div class="container">
        <div class="row justify-content-center">
          <h3 class="text-center">HASIL PENGERJAAN KAMI</h3>
          <?php
          foreach ($hasil as $key => $prs) { ?>
            <div class="col-md-6 thumb-hasil">
              <img src="<?= base_url($prs->path_img_big) ?>" alt="car" class="img-fluid">
            </div>
          <?php } ?>
        </div>
